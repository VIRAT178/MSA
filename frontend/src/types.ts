...
export function getSportIcon(sportId: string, className = "h-5 w-5 text-red-600") {
  ...
  } else if (normId.includes("tabletennis") || normId.includes("table tennis")) {
