...
import { Ticket, Calendar, Shield, Sparkles, Trophy, MapPin, UserCheck, AlertCircle } from "lucide-react";
...
export default function Admissions() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(apiPath("/api/admissions"), {
        method: "POST",
        headers: {
      ...
      const selectedSportName = SPORTS_PROGRAMS.find(s => s.id === formData.selectedSport)?.name || "Cricket";
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          ...
          <p className="text-zinc-650 text-sm sm:text-base leading-relaxed font-semibold">
            Register for a complimentary performance evaluation session. Our BCCI, FIBA, and AFC-licensed advisors will assess your fitness, endurance, and technical attributes.
          </p>
        </div>
          ...
          <div className="bg-white border border-zinc-200 rounded-3xl p-6 sm:p-10 shadow-xl space-y-8 animate-fade-in">
            <div className="text-center space-y-2">
              ...
              <p className="text-zinc-600 text-sm max-w-md mx-auto font-medium">
                Your credentials have been authenticated. Present this digital ticket at the Sanwer Road main gate security counter.
              </p>
            </div>
            ...
            <div className="relative border-2 border-dashed border-zinc-300 bg-zinc-50 rounded-2xl p-6 sm:p-8 space-y-6 overflow-hidden">
              ...
              <div className="border-t border-zinc-200 pt-4 bg-white p-4 rounded-xl text-left space-y-1 shadow-sm">
                ...
                <p className="text-[11px] text-zinc-600 font-bold leading-relaxed">
                  {submittedTicket.coachingGuide} Athletes are advised to report 30 minutes early to facilitate biometric screening & warming up. Contact the helpdesk at +91 95000-MSA-ID for details.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="sm:col-span-2 flex items-start space-x-2.5 pt-2">
                ...
                <label htmlFor="accepted-terms" className="text-xs text-zinc-500 font-bold leading-relaxed cursor-pointer">
                  I hereby declare that my ward is physically fit to undergo high-intensity cardiovascular training and matches. I authorize MSA's medical staff to provide emergency first aid if required.
                </label>
              </div>
