...
import { ShieldCheck, Trophy, Sparkles, MapPin, Eye, Flag, Target, HeartHandshake } from "lucide-react";
...
export default function About() {
  const pillars = [
    ...
    },
    {
      ...
      desc: "No template coaching. Each athlete receives a digital tracker customized by our BCCI, FIBA, and AFC-licensed advisors."
    },
    {
      icon: <HeartHandshake className="h-6 w-6 text-purple-400" />,
      title: "Indore Community Trust",
      desc: "Rooted deeply on Sanwer Road, we serve as the premier sports launchpad for Indore, training state & national team prospective players."
    }
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <p className="text-zinc-600 text-base sm:text-lg leading-relaxed">
            Founded with a vision to revolutionize grassroots athletics in Central India, MSA provides athletes with national-standard coaching, state-of-the-art facilities, and AI-enabled diagnostics.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
          ...
          <div className="lg:col-span-6 relative group">
            <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-red-600 to-amber-600 opacity-10 blur-xl group-hover:opacity-25 transition duration-1000" />
            <div className="relative rounded-2xl border border-zinc-200 bg-white overflow-hidden shadow-md">
              <img
                src={academyBuilding}
                alt="MSA Campus Building"
                className="w-full h-80 object-cover object-center opacity-95 group-hover:opacity-100 group-hover:scale-105 transition-transform duration-700"
              />
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl border border-zinc-200/80 bg-white/95 backdrop-blur-md shadow-lg">
                ...
                <div className="mt-3 flex items-center justify-between border-t border-zinc-100 pt-2 text-xs">
                  ...
                  <span className="text-zinc-500 font-bold">Sanwer Road Campus</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="rounded-2xl border border-zinc-200 bg-zinc-50/50 p-6 sm:p-8 space-y-4 shadow-sm">
              ...
              <p className="text-zinc-600 text-sm sm:text-base leading-relaxed font-medium">
                To offer world-class sport pathways that fuse professional coaching certifications with state-of-the-art telemetry and personalized diagnostics. We break socio-economic barriers to uplift every talented youth in Malwa.
              </p>
            </div>
          </div>
