...
import { SportProgram, getSportIcon } from "../types";
import { SPORTS_PROGRAMS } from "../data";
import { ChevronLeft, Calendar, ShieldCheck, Clock, Award, Users, BookOpen, UserCheck, Dumbbell, Sparkles } from "lucide-react";
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs font-mono text-zinc-500 uppercase font-bold">
            Malwa Sports Academy Elite Syllabus
          </span>
        </div>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-zinc-950 shadow-lg h-[340px] sm:h-[420px]">
          {/* Cover image */}
          <div 
            className="absolute inset-0 transform scale-100 transition-all duration-700"
            style={{ 
          ...
          <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 p-4 sm:p-6 text-white z-10 space-y-2">
            ...
            <div className="flex items-center space-x-3.5">
              ...
              <h1 className="font-display text-2xl sm:text-4xl font-black uppercase text-white tracking-wide leading-none">
                {sport.name} <span className="text-red-500">ACADEMY</span>
              </h1>
            </div>
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="rounded-2xl border border-zinc-200 bg-white p-6 sm:p-8 space-y-4 shadow-sm">
              ...
              <p className="text-zinc-500 text-xs font-bold">
                * Athletes are expected to report 15 minutes prior to the scheduled timing in complete MSA academy kit.
              </p>
            </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="rounded-2xl border border-red-200 bg-red-50 p-6 text-center space-y-4 shadow-sm relative">
              ...
              <p className="text-zinc-650 text-xs font-semibold leading-relaxed">
                Book a professional trial and evaluation session with our head sport analyst on Sanwer Road, Indore.
              </p>
