...
function getTransporter() {
  ...
  if (host.includes("@")) {
    console.warn("⚠️ SMTP_HOST appears invalid because it includes an email address. Please set SMTP_HOST to your SMTP server host name (for example smtp.gmail.com).");
  }
